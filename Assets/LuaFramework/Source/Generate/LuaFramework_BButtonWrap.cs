...
public class LuaFramework_BButtonWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaFramework.BButton), typeof(UnityEngine.MonoBehaviour));
	...
	static int OnPointerDown(IntPtr L)
	{
		try
		{
			...
			LuaFramework.BButton obj = (LuaFramework.BButton)ToLua.CheckObject<LuaFramework.BButton>(L, 1);
	...
	static int get_param(IntPtr L)
	{
		...
		try
		{
			...
			LuaFramework.BButton obj = (LuaFramework.BButton)o;
	...
	static int get_triggerMethod(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LuaFramework.BButton obj = (LuaFramework.BButton)o;
			LuaFramework.BButton.TriggerMethod ret = obj.triggerMethod;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_triggerMethod(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LuaFramework.BButton obj = (LuaFramework.BButton)o;
			LuaFramework.BButton.TriggerMethod arg0 = (LuaFramework.BButton.TriggerMethod)ToLua.CheckObject(L, 2, typeof(LuaFramework.BButton.TriggerMethod));
