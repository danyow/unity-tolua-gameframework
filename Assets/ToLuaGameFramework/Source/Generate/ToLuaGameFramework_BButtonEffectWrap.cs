...
public class ToLuaGameFramework_BButtonEffectWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(ToLuaGameFramework.BButtonEffect), typeof(UnityEngine.MonoBehaviour));
	...
	static int OnPointerDown(IntPtr L)
	{
		try
		{
			...
			ToLuaGameFramework.BButtonEffect obj = (ToLuaGameFramework.BButtonEffect)ToLua.CheckObject<ToLuaGameFramework.BButtonEffect>(L, 1);
	...
	static int get_targetImg(IntPtr L)
	{
		...
		try
		{
			...
			ToLuaGameFramework.BButtonEffect obj = (ToLuaGameFramework.BButtonEffect)o;
