...
1.  开发模式：LuaConfig.cs里将UseLuaBundle和UseResBundle设置为false，读取LuaDev目录下实时编写的代码。 
2.  发布模式：LuaConfig.cs里将UseLuaBundle和UseResBundle设置为true，加载AB包里的代码。菜单ToLuaUIFramework->Build XXX AssetBundle。 
